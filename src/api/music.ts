...
export const rateSong = async (songId: number, score: number) => {
    try {
        const response = await api.post(`/api/music/songs/${songId}/rate/`, { score });
        return response.data;
    } catch (error) {
...
export const addComment = async (songId: number, content: string) => {
    try {
        const response = await api.post(`/api/music/songs/${songId}/comment/`, { content });
        return response.data;
    } catch (error) {
...
export const createPlaylist = async (title: string, isPublic: boolean = true) => {
    try {
...
export const addSongToPlaylist = async (playlistId: number, songId: number) => {
    try {
        const response = await api.post(`/api/music/playlists/${playlistId}/add_song/`, { 
            song_id: songId 
        });
        return response.data;
    } catch (error) {
...
export const removeSongFromPlaylist = async (playlistId: number, songId: number) => {
    try {
        const response = await api.post(`/api/music/playlists/${playlistId}/remove_song/`, { 
            song_id: songId 
        });
        return response.data;
    } catch (error) {
